pipeline {
    agent any
    environment {
        DOCKER_HUB_REPO = "khanaarsalan007/my-flask-app"
    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                //sh 'docker push khanaarsalan007/my-flask-app:$BUILD_NUMBER'
                //sh 'docker push khanaarsalan007/my-flask-app:latest'
